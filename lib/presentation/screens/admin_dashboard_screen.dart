import 'package:arrpa7y/presentation/screens/ai_assistant_screen.dart';
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'حالة السيرفر: متصل • البوابة المالية: $totalWallets محفظة نشطة',
                ...
                // 3️⃣ أدوات التحكم السريع (بما فيها المساعد الذكي AI)
                const AppSectionHeader(
                ...
                GridView.count(
                  ...
                  children: [
                    ...
                    _buildActionTile(
                      context,
                      title: 'إدارة السيرفر',
                      subtitle: 'مستعرض الكود والملفات',
